...
function getTaskIcon(task) {
    var icons = {
        detection: lucideReact.Target,
        classification: lucideReact.Tag,
        segmentation: lucideReact.Palette,
        'multi-type': lucideReact.BarChart3
    };
    return icons[task] || lucideReact.BarChart3;
}
/**
...
function ResultsDisplay(_a) {
    ...
    var _c = require$$0.useState('classes'), viewMode = _c[0], setViewMode = _c[1];
...
exports.BoundingBoxComponent = BoundingBox;
exports.OverlayRenderer = OverlayRenderer;
exports.ResultsDisplay = ResultsDisplay;
exports.SegmentationOverlay = SegmentationOverlay;
exports.cn = cn;
exports.formatConfidence = formatConfidence;
exports.formatTimestamp = formatTimestamp;
exports.getTaskColor = getTaskColor;
exports.getTaskIcon = getTaskIcon;
