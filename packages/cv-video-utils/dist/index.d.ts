export { validateMediaFile, validateVideoFile } from '@lidvizion/cv-validation';
 ...
 */
declare const extractVideoSnapshot: (videoFile: File, timestamp?: number) => Promise<File>;
/**
 * Get video duration in seconds
 * @param videoFile - The video file
 * @returns Promise<number> - Duration in seconds
 */
declare const getVideoDuration: (videoFile: File) => Promise<number>;
/**
 * Check if a file is a video file
 * @param file - The file to check
 * @returns boolean - True if the file is a video
 */
declare const isVideoFile: (file: File) => boolean;
/**
...
export { extractVideoSnapshot, formatFileSize, getVideoDuration, isVideoFile };
